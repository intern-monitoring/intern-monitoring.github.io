...
export const tableSeleksiMitra = `
<tr>
...
<td class="h-px w-px whitespace-nowrap">
  <div class="flex justify-center py-3">
    <span
      class="#BGCOLOR# inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-xs font-medium text-gray-900"
    >
      #STATUSMOU#
    </span>
  </div>
...
export function isiRow(value) {
  const statusmou =
    value.mou === 1 ? "Lolos" : value.mou === 2 ? "Tidak Lolos" : "Proses";
  ...
  const content = tableSeleksiMitra
    ...
    .replace("#STATUSMOU#", statusmou)
    .replace("#BGCOLOR#", bgstatus)
    .replace("#DETAIL#", value._id)
    .replace("#TERIMA#", value._id);
  addInner("seleksiMitra", content);
}
