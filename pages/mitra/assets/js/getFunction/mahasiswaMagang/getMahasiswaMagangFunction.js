...
const get = (target_url, responseFunction) => {
  ...
  fetch(target_url, requestOptions)
    ...
    .then((result) => {
      ...
      localStorage.setItem("mahasiswaMagang", JSON.stringify(parsedResult));
      ...
      searchInput.addEventListener("keyup", () => {
        ...
        if (searchQuery) {
          ...
          filteredData = localStorage.getItem("mahasiswaMagang")
            ? JSON.parse(localStorage.getItem("mahasiswaMagang"))
            : parsedResult;
        }
