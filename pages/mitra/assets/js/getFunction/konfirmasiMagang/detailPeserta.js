...
export function isiRow(value) {
  ...
  const konfirmasi = detailPeserta
    ...
    .replace("#BERKAS#", statusBerkas)
    .replace("#WAWANCARA#", statusWawancara)
    .replace("#WEBSITE#", value.magang.mitra.website);
  addInner("detailKonfirmasiMagang", konfirmasi);
}
