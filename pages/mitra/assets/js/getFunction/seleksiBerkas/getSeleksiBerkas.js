...
export const URLGetSeleksiBerkas =
  "https://asia-southeast2-bursakerja-project.cloudfunctions.net/intermoni-mahasiswa-magang/intermoni-mahasiswa-magang/seleksi";
...
<td class="h-px w-px whitespace-nowrap">
  <a
    href="detailSeleksiBerkas?pesertaId=#DETAIL#"
    type="button"
    class="block"
  >
...
export function isiRowLolos(value) {
  if (value.seleksiberkas === 1) {
    ...
    const lolos = seleksiLolos
      ...
      .replace("#PRODI#", value.mahasiswa.prodi)
      .replace("#PERGURUAN#", value.mahasiswa.perguruantinggi)
      .replace("#LOLOS#", lolosBerkas)
      .replace("#POSISI#", value.magang.posisi)
      .replace("#DETAIL#", value._id);
    addInner("lolosSeleksiBerkas", lolos);
  }
}

export function isiRowTidakLolos(value) {
  if (value.seleksiberkas === 2) {
    const tidaklolosBerkas = "Tidak Lolos";
    ...
    const tidaklolos = seleksiTidakLolos
      ...
      .replace("#PRODI#", value.mahasiswa.prodi)
      .replace("#PERGURUAN#", value.mahasiswa.perguruantinggi)
      .replace("#TIDAKLOLOS#", tidaklolosBerkas)
      .replace("#POSISI#", value.magang.posisi)
      .replace("#DETAIL#", value._id);
    addInner("tidakLolosSeleksiBerkas", tidaklolos);
  }
}
